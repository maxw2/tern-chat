(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.li = {}));
    ...
    ***************************************************************************** */
    ...
    exports.VirtualList = class VirtualList extends i$1 {
        constructor() {
            super(...arguments);
            this.list = [];
            this.itemMax = 40;
        ...
        render() {
            return x `<div class="virtual-list" @scroll=${this.onScroll}>
      <div class="list-container" style="height:${this.getMaxHeight()}"></div>
      <div class="list-items" style="transform: translateY(${this.top}px)">
        ${c(this.itemsList, (_item, index) => this.startBuffer + index, (item, index) => x `<div class="list-item" data-key="${this.startIdx + index}">
              ${this.renderItem
            ? o(this.renderItem(item, this.startBuffer + index))
            : null}
            </div>`)}
      </div>
    </div>`;
    ...
    exports.VirtualList.styles = i$4 `
    :host {
      display: block;
    }
    .virtual-list {
  ...
  `;
    __decorate([
        e$2('.virtual-list')
    ], exports.VirtualList.prototype, "listEl", void 0);
    __decorate([
        e$2('.list-items')
    ], exports.VirtualList.prototype, "itemEl", void 0);
    __decorate([
        e$2('.list-item')
    ], exports.VirtualList.prototype, "itemEls", void 0);
    __decorate([
        n({ type: Array })
    ], exports.VirtualList.prototype, "list", void 0);
    __decorate([
        n({ type: Number })
    ], exports.VirtualList.prototype, "itemMax", void 0);
    __decorate([
        n({ type: Number })
    ], exports.VirtualList.prototype, "estimate", void 0);
    __decorate([
        n({ type: Number })
    ], exports.VirtualList.prototype, "buffer", void 0);
    __decorate([
        n({ type: Function })
    ], exports.VirtualList.prototype, "renderItem", void 0);
    __decorate([
        n({ type: Array })
    ], exports.VirtualList.prototype, "itemsList", void 0);
    __decorate([
        n({ type: Number })
    ], exports.VirtualList.prototype, "top", void 0);
    exports.VirtualList = __decorate([
        t$2('virtual-list')
    ], exports.VirtualList);
